...
const tweetList = [
  {
    ...
    desc: (
      <p>
        Aminur islam <a href="#">@Vishwas EduVibe #HTML_Template</a> Grab your
  ...
  },
  {
    ...
    desc: (
      <p>
        Somrat islam <a href="#">@Vishwas EduVibe #HTML_Template</a> Grab your
        item, 50% Big Sale Offer !!
      </p>
    ),
  },
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>
              &copy; 2022 <Link to="/">EduVibe</Link> Designed by{" "}
              <a href="https://themeforest.net/user/Vishwas" target="_blank">
                Vishwas
              </a>{" "}
            </p>
